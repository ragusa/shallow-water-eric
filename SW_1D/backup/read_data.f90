MODULE input_data
  ...
  TYPE my_data
     ...
     INTEGER                        :: syst_size
     REAL(KIND=8)                   :: htiny
     REAL(KIND=8)                   :: epsilon_htiny, max_water_h, epsilon_limit, &
                                        epsilon_regul_h
...
CONTAINS
  SUBROUTINE read_my_data(data_fichier)
    ...
    inputs%epsilon_htiny = 1.d-13
    inputs%epsilon_limit = 1.d-13
    inputs%epsilon_regul_h = 1.d-13
    ...
    CALL read_until(in_unit, "===Limiter type===")
