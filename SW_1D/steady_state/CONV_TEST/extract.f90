program extract
  ...
  CHARACTER(LEN=40) :: fich, stuff1, stuff2, stuff3, stuff4, stuff5, stuff6
  CHARACTER(LEN=1)  :: c
  CHARACTER(LEN=2)  :: cc
  ...
  DO i = 1, nb_fich
     ...
     DO k= 1, 3
        READ(11,*) stuff1
     END DO
     READ(11,*) stuff1, stuff2, stuff3, stuff4, stuff5, stuff6, err1
     READ(11,*) stuff1, stuff2, stuff3, stuff4, stuff5, stuff6, err2
     READ(11,*) stuff1, stuff2, stuff3, stuff4, stuff5, erri
     CLOSE(11)
     IF (i==1) THEN
        i0 = 100*2**(i-1)
